...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] bool ConformY = false;  // Conform to screen safe area on Y-axis (default true, disable to ignore)
        ...
        Rect GetSafeArea ()
        {
            ...
            if (SimulateInEditor && Application.isEditor && Sim != SimDevice.None)
            {
